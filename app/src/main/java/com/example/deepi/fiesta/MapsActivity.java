...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Intent i=getIntent();
        vm=i.getExtras().getString("venue");
        adm=new AppDBManager(this);
        adm.openDb();
        Cursor c=adm.fetchdescription(vm);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        double d2 = Double.parseDouble(longi);
        float zoom=15;
        // Add a marker in Sydney and move the camera
        LatLng sydney = new LatLng(d,d2);
        mMap.addMarker(new MarkerOptions().position(sydney).title("Marker in Mocha"));
